...
// Note: email and mobile already have unique indexes from schema definition
...
userSchema.methods.isEmailOTPValid = function(otp) {
  ...
  return hashedOtp === this.emailVerificationCode && this.emailVerificationExpires > Date.now();
};
